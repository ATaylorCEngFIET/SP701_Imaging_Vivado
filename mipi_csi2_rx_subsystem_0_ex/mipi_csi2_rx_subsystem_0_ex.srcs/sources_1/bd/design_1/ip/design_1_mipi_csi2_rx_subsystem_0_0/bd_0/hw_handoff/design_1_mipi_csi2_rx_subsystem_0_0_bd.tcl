...
################################################################
# This is a generated script based on design: bd_bf15
#
...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0x00010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces csirxss_s_axi] [get_bd_addr_segs phy/s_axi/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces csirxss_s_axi] [get_bd_addr_segs rx/s_axi/reg0] -force
