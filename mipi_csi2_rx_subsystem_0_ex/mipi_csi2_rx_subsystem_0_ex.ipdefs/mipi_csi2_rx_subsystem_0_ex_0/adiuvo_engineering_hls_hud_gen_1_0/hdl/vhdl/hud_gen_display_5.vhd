...
entity hud_gen_display_5_rom is 
    generic(
             DWIDTH     : integer := 25; 
             AWIDTH     : integer := 7; 
...
architecture rtl of hud_gen_display_5_rom is 

signal addr0_tmp : std_logic_vector(AWIDTH-1 downto 0); 
type mem_array is array (0 to MEM_SIZE-1) of std_logic_vector (DWIDTH-1 downto 0); 
signal mem : mem_array := (
    0 to 10=> "1000000000000000011111111", 11 to 19=> "0000000000000000000000000", 
    ...
    50 to 59=> "1000000000000000011111111", 60 to 68=> "0000000000000000000000000", 
...
architecture arch of hud_gen_display_5 is
    component hud_gen_display_5_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    hud_gen_display_5_rom_U :  component hud_gen_display_5_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
